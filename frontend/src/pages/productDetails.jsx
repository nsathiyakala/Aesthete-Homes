...
export default function ProductDetails({cartItem, setCartItems}) {
    const [productDetail, setProductDetail] = useState(null)
    const { id } = useParams()

    useEffect(() => {
        fetch(process.env.REACT_APP_API_URL + "/featuredproduct/" + id)
            .then(res => res.json())
            .then(res => setProductDetail(res.FeaturedSingleproduct))
